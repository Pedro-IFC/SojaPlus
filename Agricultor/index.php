                            ...
                            <div class="card-content">
                                ...
                                <div class="col s6">
                                        <div class="form-field, input-field white-text">
                                            ...
                                            <p>
                                                <label>
                                                    <input name="group1" type="radio" name="sexo" id="sexo1" value="M" checked  <?php if($linha['genero']=="M") echo "checked"; ?>>
                                                    <span>Masculino</span>
                                                </label>
                                            </p>
                                            ...
                                            <p>
                                                <label>
                                                    <input name="group1" type="radio" name="sexo" id="sexo2" value="F" <?php if($linha['genero']=="F") echo "checked"; ?>>
                                                    <span>Feminino</span>
                                                </label>
                                            </p>
                                        </div>
