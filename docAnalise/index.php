...
<head>
    ...
    ?>
    <meta charset="UTF-8">
    <title>Cadastro Documento</title>
    <meta charset="UTF-8">
                    ...
                    <div>
                        <div class="card">
                            <div class="card-action light-green darken-1 white-text">
                                <h3>CADASTRO DE DOCUMENTO DE ANÁLISE DO SOLO</h3>
                            </div>
                            <div class="card-content">
                        <div class="col s6">
                            <div class="form-field, input-field white-text">
                            <label for="quant" class="form-label" >Quantidade de elemento(mg/dm³)(P,K,Ca,Mg)</label>
...
<script src="../js-adicional/cadastrarDocumento.js"></script>
